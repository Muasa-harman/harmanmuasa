...
export interface ScripayServices {
  //router: Router
...
export class Scripay<T = any> {
  ...
  constructor(
    private config: ScripayServices,
...
export function createApp(
  config: ScripayServices,
  routes: ILPMiddleware<any>
): Scripay {
  return new Scripay(config, routes)
}
